...
! This code was generated by Write_ChckOutLst.m at 05-Nov-2015 09:57:49.
   ...
   INTEGER(IntKi), PARAMETER      :: NTMD_XQ   =  9
   INTEGER(IntKi), PARAMETER      :: NTMD_XQD  =  10
   INTEGER(IntKi), PARAMETER      :: NTMD_YQ   = 11
   INTEGER(IntKi), PARAMETER      :: NTMD_YQD  = 12


     ! Tower Tuned Mass Damper (TMD):

   INTEGER(IntKi), PARAMETER      :: TTMD_XQ   = 13
   INTEGER(IntKi), PARAMETER      :: TTMD_XQD  = 14
   INTEGER(IntKi), PARAMETER      :: TTMD_YQ   = 15
   INTEGER(IntKi), PARAMETER      :: TTMD_YQD  = 16

     ! Airfoil Control (might be used for flap actuation):

   INTEGER(IntKi), PARAMETER      :: BlAirFlC1  = 17
   INTEGER(IntKi), PARAMETER      :: BlAirFlC2  = 18
   INTEGER(IntKi), PARAMETER      :: BlAirFlC3  = 19
   
     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER      :: MaxOutPts = 19
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(23) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "YAWMOMCOM","YAWERR   "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(23) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                ...
                                YawMomCom, YawErr/)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(23) =  (/ &                     ! This lists the units corresponding to the allowed parameters
                               "(-)       ","(-)       ","(-)       ","(-)       ","(-)       ","(-)       ","(deg)     ", &

...
! This code was generated by Write_ChckOutLst.m at 05-Nov-2015 09:57:49.
   ...
   INTEGER(IntKi), PARAMETER      :: YawErr    =  8
   INTEGER(IntKi), PARAMETER      :: FlowDef   =  9
   INTEGER(IntKi), PARAMETER      :: AssAng    =  10


     ! Nacelle Tuned Mass Damper (TMD):

   INTEGER(IntKi), PARAMETER      :: NTMD_XQ   =  11
   INTEGER(IntKi), PARAMETER      :: NTMD_XQD  =  12
   INTEGER(IntKi), PARAMETER      :: NTMD_YQ   =  13
   INTEGER(IntKi), PARAMETER      :: NTMD_YQD  =  14


     ! Tower Tuned Mass Damper (TMD):

   INTEGER(IntKi), PARAMETER      :: TTMD_XQ   =  15
   INTEGER(IntKi), PARAMETER      :: TTMD_XQD  =  16
   INTEGER(IntKi), PARAMETER      :: TTMD_YQ   =  17
   INTEGER(IntKi), PARAMETER      :: TTMD_YQD  =  18

     ! Airfoil Control (might be used for flap actuation):

   INTEGER(IntKi), PARAMETER      :: BlAirFlC1  =  19
   INTEGER(IntKi), PARAMETER      :: BlAirFlC2  =  20
   INTEGER(IntKi), PARAMETER      :: BlAirFlC3  =  21
   
     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER      :: MaxOutPts =  21
...
!   AllOuts(Time) = t    
   ...
   AllOuts(YawMomCom) = -0.001*y%YawMom ! Unit?
   AllOuts(YawErr) = u%YawErr*R2D
   AllOuts(FlowDef) = u%FlowDef*R2D
   AllOuts(AssAng) = u%AssAng*R2D
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(25) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "ASSANG   ","BLAIRFLC1","BLAIRFLC2","BLAIRFLC3","BLFLAP1  ","BLFLAP2  ","BLFLAP3  ","BLPITCHC1", &
                               "BLPITCHC2","BLPITCHC3","FLOWDEF  ","GENPWR   ","GENTQ    ","HSSBRTQC ","NTMD_XQ  ","NTMD_XQD ", &
                               "NTMD_YQ  ","NTMD_YQD ","TTMD_XQ  ","TTMD_XQD ","TTMD_YQ  ","TTMD_YQD ","YAWERR   ","YAWMOM   ", &
                               "YAWMOMCOM"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(25) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                   AssAng , BlAirFlC1 , BlAirFlC2 , BlAirFlC3 , BlAirFlC1 , BlAirFlC2 , BlAirFlC3 , BlPitchC1 , &
                                BlPitchC2 , BlPitchC3 ,   FlowDef ,    GenPwr ,     GenTq ,  HSSBrTqC ,   NTMD_XQ ,  NTMD_XQD , &
                                  NTMD_YQ ,  NTMD_YQD ,   TTMD_XQ ,  TTMD_XQD ,   TTMD_YQ ,  TTMD_YQD ,    YawErr , YawMomCom , &
                                YawMomCom/)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(25) =  (/ &                     ! This lists the units corresponding to the allowed parameters
                               "(deg)     ","(-)       ","(-)       ","(-)       ","(-)       ","(-)       ","(-)       ","(deg)     ", &
                               "(deg)     ","(deg)     ","(deg)     ","(kW)      ","(kN-m)    ","(kN-m)    ","(m)       ","(m/s)     ", &
                               "(m)       ","(m/s)     ","(m)       ","(m/s)     ","(m)       ","(m/s)     ","(deg)     ","(kN-m)    ", &
                               "(kN-m)    "/)
